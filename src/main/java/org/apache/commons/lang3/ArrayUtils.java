...
public class ArrayUtils {
    ...
    public static org.apache.commons.lang3.ArrayUtils ArrayUtils;
    ...
    public static <T> T[] removeAllOccurences(T[] array, T element) {
        return (T[]) removeAll((Object)array, (BitSet)indexesOf(array, element));
    }
    ...
    public static int[] subarray(int[] array, int startIndexInclusive, int endIndexExclusive) {
        if (array == null) {
            ...
            int newSize = endIndexExclusive - startIndexInclusive + 1;
            if (newSize <= 0) {
    ...
    public static Object toPrimitive(Object array) {
        if (array == null) {
            ...
            if (Boolean.TYPE.equals(pt)) {
                return toPrimitive((Boolean[])((Boolean[])array));
            } else if (Character.TYPE.equals(pt)) {
                return toPrimitive((Character[])((Character[])array));
            } else if (Byte.TYPE.equals(pt)) {
                return toPrimitive((Byte[])((Byte[])array));
